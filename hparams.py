...
hparams = tf.contrib.training.HParams(
	...
	upsample_scales = [4, 4, 4, 4], #prod(upsample_scales) should be equal to hop_size
	...
	#This ensures GTA synthesis goes up to 40x faster than one sample at a time and uses 100% of your GPU computation power.
